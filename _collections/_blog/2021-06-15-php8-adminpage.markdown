...
회원 리스트의 값을 화면에 출력해야 하기 때문에 **SELECT문**을 사용한다. 
...
<pre>
    < table>
        < tr>
            < td>< ?php echo $array[" 컬럼명1"]; ? >< /td>
            < td>< ?php echo $array[" 컬럼명2"]; ? >< /td>
            < td>< ?php echo $array[" 컬럼명3"]; ? >< /td>
            < td>< ?php echo $array[" 컬럼명4"]; ? >< /td>
            < td>< ?php echo $array[" 컬럼명5"]; ? >< /td>
            < td>< ?php echo $array[" 컬럼명6"]; ? >< /td>
            < td>< ?php echo $array[" 컬럼명7"]; ? >< /td>
            < td>< a href="edit.php?g_idx=< ?php echo $ array[" idx"]; ? >">수정< /a>< /td>
            < td>< a href="#" onclick='del_mem(< ?php echo $ array[" dx"]; ? >)'>삭제< /a>< /td>
        < tr>
    < /table>
</pre>
